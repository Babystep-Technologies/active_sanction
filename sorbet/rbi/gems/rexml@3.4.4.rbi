...
# event.
#
# pkg:gem/rexml#lib/rexml/parsers/pullparser.rb:107
class REXML::Parsers::PullEvent
  # The type of this event.  Will be one of :tag_start, :tag_end, :text,
  # :processing_instruction, :comment, :doctype, :attlistdecl, :entitydecl,
  # :notationdecl, :entity, :cdata, :xmldecl, or :error.
  #
  # pkg:gem/rexml#lib/rexml/parsers/pullparser.rb:111
  def initialize(arg); end

  # pkg:gem/rexml#lib/rexml/parsers/pullparser.rb:115
  def [](start, endd = T.unsafe(nil)); end

  # Content: [ String text ]
  #
  # pkg:gem/rexml#lib/rexml/parsers/pullparser.rb:164
  def attlistdecl?; end

  # Content: [ String text ]
  #
  # pkg:gem/rexml#lib/rexml/parsers/pullparser.rb:195
  def cdata?; end

  # Content: [ String text ]
  #
  # pkg:gem/rexml#lib/rexml/parsers/pullparser.rb:154
  def comment?; end

  # Content: [ String name, String pub_sys, String long_name, String uri ]
  #
  # pkg:gem/rexml#lib/rexml/parsers/pullparser.rb:159
  def doctype?; end

  # Content: [ String text ]
  #
  # pkg:gem/rexml#lib/rexml/parsers/pullparser.rb:169
  def elementdecl?; end

  # Content: [ String tag_name ]
  #
  # pkg:gem/rexml#lib/rexml/parsers/pullparser.rb:139
  def end_element?; end

  # Content: [ String text ]
  #
  # pkg:gem/rexml#lib/rexml/parsers/pullparser.rb:190
  def entity?; end
  ...
  # Content: [ String text ]
  #
  # pkg:gem/rexml#lib/rexml/parsers/pullparser.rb:180
  def entitydecl?; end

  # pkg:gem/rexml#lib/rexml/parsers/pullparser.rb:204
  def error?; end

  # pkg:gem/rexml#lib/rexml/parsers/pullparser.rb:129
  def event_type; end

  # pkg:gem/rexml#lib/rexml/parsers/pullparser.rb:208
  def inspect; end

  # Content: [ String text ]
  #
  # pkg:gem/rexml#lib/rexml/parsers/pullparser.rb:149
  def instruction?; end

  # Content: [ String text ]
  #
  # pkg:gem/rexml#lib/rexml/parsers/pullparser.rb:185
  def notationdecl?; end

  # Content: [ String tag_name, Hash attributes ]
  #
  # pkg:gem/rexml#lib/rexml/parsers/pullparser.rb:134
  def start_element?; end

  # Content: [ String raw_text, String unnormalized_text ]
  #
  # pkg:gem/rexml#lib/rexml/parsers/pullparser.rb:144
  def text?; end

  # Content: [ String version, String encoding, String standalone ]
  #
  # pkg:gem/rexml#lib/rexml/parsers/pullparser.rb:200
  def xmldecl?; end
end
...
# Nat Price gave me some good ideas for the API.
#
# pkg:gem/rexml#lib/rexml/parsers/pullparser.rb:29
class REXML::Parsers::PullParser
  include ::REXML::XMLTokens
  extend ::Forwardable

  # pkg:gem/rexml#lib/rexml/parsers/pullparser.rb:38
  def initialize(stream); end

  # pkg:gem/rexml#lib/rexml/parsers/pullparser.rb:45
  def add_listener(listener); end

  # pkg:gem/rexml#lib/rexml/parsers/pullparser.rb:62
  def each; end

  # pkg:gem/rexml#lib/rexml/parsers/pullparser.rb:35
  def empty?(*_arg0, **_arg1, &_arg2); end

  # pkg:gem/rexml#lib/rexml/parsers/pullparser.rb:34
  def entity(*_arg0, **_arg1, &_arg2); end

  # pkg:gem/rexml#lib/rexml/parsers/pullparser.rb:50
  def entity_expansion_count; end

  # pkg:gem/rexml#lib/rexml/parsers/pullparser.rb:54
  def entity_expansion_limit=(limit); end

  # pkg:gem/rexml#lib/rexml/parsers/pullparser.rb:58
  def entity_expansion_text_limit=(limit); end

  # pkg:gem/rexml#lib/rexml/parsers/pullparser.rb:33
  def has_next?(*_arg0, **_arg1, &_arg2); end

  # pkg:gem/rexml#lib/rexml/parsers/pullparser.rb:68
  def peek(depth = T.unsafe(nil)); end

  # pkg:gem/rexml#lib/rexml/parsers/pullparser.rb:78
  def pull; end

  # pkg:gem/rexml#lib/rexml/parsers/pullparser.rb:97
  def reset; end

  # pkg:gem/rexml#lib/rexml/parsers/pullparser.rb:36
  def source(*_arg0, **_arg1, &_arg2); end

  # pkg:gem/rexml#lib/rexml/parsers/pullparser.rb:93
  def unshift(token); end
end
